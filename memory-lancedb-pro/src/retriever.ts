...
export interface RetrievalConfig {
   ...
   *  - "dashscope": same format as jina via DashScope compatible rerank endpoint
  ...
  rerankProvider?: "jina" | "dashscope" | "siliconflow" | "voyage" | "pinecone";
  /**
...
type RerankProvider = "jina" | "dashscope" | "siliconflow" | "voyage" | "pinecone";
...
export class MemoryRetriever {
  ...
  private async runBM25Search(
    ...
    const filtered = category
      ? active.filter((r) => r.entry.category === category)
      : active;

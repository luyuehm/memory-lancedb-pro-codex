 ...
 * - buildDedupPrompt: CREATE/MERGE/SKIP/SUPERSEDE dedup decision
...
- SUPERSEDE: Candidate memory replaces an older truth on the same topic for temporal categories like preferences/entities. Use when the new candidate expresses the current value and the old memory should be kept only as history.
...
- "preferences" and "entities" may use SUPERSEDE when the same fact topic has changed over time.
